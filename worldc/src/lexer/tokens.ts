...
export const WORLDC_KEYWORDS = new Set([
  'vec2',
  'vec3',
  'vec4',
  'ivec2',
...
export const WORLDC_VERBIAGE = new Set(['edict', 'pass', 'invoke']);
...
export class TokenUtils {
  static isKeyword(value: string): boolean {
    return (
      ...
      WORLDC_KEYWORDS.has(value) ||
      WORLDC_VERBIAGE.has(value)
    );
  }
