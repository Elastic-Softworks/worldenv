...
/*
         ...
         WorldCDeploymentManager
           ---
           main API class for WORLDC production deployment.
...
export class WorldCDeploymentManager {
...
export class DeploymentManagerFactory {
  public static createForDevelopment(): WorldCDeploymentManager {
    return new WorldCDeploymentManager({
  ...
  public static createForProduction(): WorldCDeploymentManager {
    return new WorldCDeploymentManager({
  ...
  public static createForTesting(): WorldCDeploymentManager {
    return new WorldCDeploymentManager({
