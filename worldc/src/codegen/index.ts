...
/*
         ...
         index.ts
           ---
           main code generation API for WORLDC language.
...
/*
         ...
         WorldCCodeGenerator
           ---
           main API class for WORLDC code generation.
...
export class WorldCCodeGenerator {
  ...
  /*
           ...
           compile()
             ...
             compiles WORLDC source code to specified targets
...
export class CodeGeneratorFactory {
  public static createDefault(outputDirectory?: string): WorldCCodeGenerator {
    return new WorldCCodeGenerator(outputDirectory);
  }

  public static createOptimized(outputDirectory?: string): WorldCCodeGenerator {
    const generator = new WorldCCodeGenerator(outputDirectory);
    /* would configure for optimized compilation */
    return generator;
  }

  public static createDebug(outputDirectory?: string): WorldCCodeGenerator {
    const generator = new WorldCCodeGenerator(outputDirectory);
