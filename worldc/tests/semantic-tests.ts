...
/**
 * WORLDC Semantic Analysis Test Suite
 *
...
const globalTypeChecker = new TypeChecker();
...
class SemanticTestSuite {
  ...
  private printResults(): void {
    ...
    // Statistics
    const totalSymbols = this.results.reduce(
      (sum, r) => sum + r.symbolsFound,
      0
    );
    const totalTypesChecked = this.results.reduce(
      (sum, r) => sum + r.typesChecked,
      0
    );
    ...
    if (failed === 0) {
      ...
      console.log('PASSED: Symbol table management is working correctly');
      console.log('PASSED: Type system is functioning properly');
      console.log('PASSED: Semantic analysis catches errors effectively');
      console.log('PASSED: Mixed language support is operational');
    } else if (failed <= total * 0.1) {
      console.log('WARNING: Minor issues detected in semantic analysis');
      console.log('PASSED: Core functionality is working');
      console.log('WARNING: Some edge cases may need attention');
    } else {
      console.log('ERROR: Significant issues detected in semantic analysis');
      console.log('ERROR: Core functionality needs review');
      console.log('ERROR: Multiple test failures require attention');
    }
