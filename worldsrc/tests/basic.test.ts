...
/*
         ...
         basic.test.ts
           ---
           basic smoke test suite for WORLDSRC Alpha Phase 20.
...
describe('WORLDSRC Package Structure', () => {
  test('should have valid package.json', () => {
    const pkg = require('../package.json');

    expect(pkg.name).toBe('@worldenv/worldsrc');
