...
/*
         ...
         assemblyscript-generator.ts
           ---
           AssemblyScript code generator for WORLDSRC language.
...
/*
         ...
         AssemblyScriptGenerator
           ---
           generates AssemblyScript code from WORLDSRC AST.
...
export class AssemblyScriptGenerator extends BaseCodeGenerator {
  ...
  */
  ...
  protected emitFileHeader(): void {
    this.emitComment('Generated AssemblyScript code from WORLDSRC');
