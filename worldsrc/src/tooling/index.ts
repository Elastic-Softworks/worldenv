...
export * from './lsp/lsp-types';

/* debugging components */
export { WorldSrcDebugSession, WorldSrcDebugAdapter } from './debugging/debug-protocol';
export * from './debugging/debug-protocol';

/* real-time compilation */
export { RealtimeCompiler, CompilationCache } from './realtime/realtime-compiler';
export * from './realtime/realtime-compiler';
...
export class WorldSrcTooling extends EventEmitter {
  ...
  */
  ...
  async updateConfiguration(newConfig: Partial<ToolingConfiguration>): Promise<void> {
  ...
  */
  ...
  async sendRequest(method: string, params: any): Promise<any> {
    ...
    switch (this.connectionType) {
      ...
      default:
        throw new Error(`Unsupported request for connection type: ${this.connectionType}`);
...
export function createDefaultConfiguration(workspaceRoot: string): ToolingConfiguration {
...
export function createMinimalConfiguration(workspaceRoot: string): ToolingConfiguration {
