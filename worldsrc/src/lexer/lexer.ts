...
import { globalErrorHandler, WorldSrcErrorHandler, ErrorType } from '../error/error-handler';
...
export class Lexer {
  ...
  private scanMultiLineComment(): void {
    ...
    if (!this.options.skipComments) {
      const tokenType = isDocComment ? TokenType.DOC_COMMENT : TokenType.MULTI_LINE_COMMENT;
  ...
  private scanNumber(): void {
    ...
    const tokenType = isFloat ? TokenType.FLOAT_LITERAL : TokenType.INTEGER_LITERAL;
    this.addToken(tokenType, value);
  }
